...
const QuizComponent = (props) => {
    ...
    const handlePrevQuestion = () => {
        ...
        const prevSelectedAnswer = selectedAnswer[prevValue] || -1;
        markAnswer({ key: prevSelectedAnswer, variant: prevSelectedAnswer == -1 ? '' : 'bg-danger' });
      };
    ...
    const handleCheckAnswer = (chosenOption, key) => {
        ...
        const newSelectedAnswers = {...selectedAnswer, [currentIndex]: key}; // zapisywanie wybranej odpowiedzi dla bieżącego pytania
